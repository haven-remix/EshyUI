...
public:
	...
	void SetNormalColor(float r, float g, float b, float a) {SetNormalColor(glm::vec4(r, g, b, a));}
	void SetHoveredColor(const glm::vec4& Color);
	void SetHoveredColor(float r, float g, float b, float a) {SetHoveredColor(glm::vec4(r, g, b, a));}
	void SetPressedColor(const glm::vec4& Color);
	void SetPressedColor(float r, float g, float b, float a) {SetPressedColor(glm::vec4(r, g, b, a));}
...
public:
	...
	euiImageEntity(float x, float y, float Width, float Height, euiAnchor Anchor, const std::string& ImagePath);
